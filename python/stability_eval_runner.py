...
exec_location = "./stability_eval"
topologies_location = "/home/nik/zoo_data/data/2016TopologyZooUCL_inverseCapacity"
...
def ProcessTopology(topology):
    ...
    cmd = '{} --topology_file {} --matrices="{}" --demand_fraction {} --flow_count_fraction 0.0 --try_count {} --aggregate_count {} --opt {}'.format(exec_location, top_location, tm_string, DEMAND_FRACTION, TRY_COUNT, AGGREGATE_COUNT, OPT)
    RunCmd(cmd)
