...
//};
//
// using TMStateMap = std::map<TopologyAndTM,
// std::unique_ptr<OptimizerTMState>>;
//
...
//};
//
//// Returns the percentiles of the distribution of a per-path value and the
/// max.
...
// std::vector<double> GetStretchDistribution(const OptimizerTMState&
// tm_state_map,
//                                           bool absolute);
//
